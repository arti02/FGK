                ...
                for (int i = 0; i < Driver.world.objects.size(); i++) {
                    ...
                    if (intersetion!=null){
                        for (Source source: sources
                            ...
                            Vector3 lightDir = source.getSourcePoint().vecSub(intersetion).normalizeProduct();
                            ...
                            tempColor = Driver.world.objects.get(i).getColor().multByLight(specular.addVec(diffuseIntensity.addVec(new Lightintencity(0.1f,0.1f,0.1f))));
